<template>
  <div class="all">
    <div class="box_saldo">
      <p class="saldo">
        Saldo YukPay
        <span style="font-weight: bold; color: #223196; padding-left: 3%">
          Rp {{ transactionServices.formatPrice(saldoYukPay) }}
        </span>
      </p>
    </div>
    ...
    <div class="form_control" style="font-size: 1.5rem">
      <div class="box_nominal">
        <input
          type="radio"
          name="radio_nominal"
          value="100000"
          v-model.number="topupData.nominal"
        />
        Rp 100.000
      </div>
      <div class="box_nominal">
    ...
    <span style="margin-top: 2rem">
      <button type="button" id="buttontopup" v-on:click="submitForm">
        Top Up Sekarang!
      </button>
    </span>
  </div>
